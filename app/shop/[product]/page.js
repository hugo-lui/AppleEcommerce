    ...
    return (
        <div>
            <div className="pl-96">
                ...
                <Image className="rounded-2xl mt-3" width={1000} height={100} src={pictures[params.product].second} alt=""/>
                <Image className="rounded-2xl mt-3" width={1000} height={100} src={pictures[params.product].third} alt=""/>
